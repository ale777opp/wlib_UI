...
/*конец экранировани символов и строковые преобразования*/
...
var ajaxForm= 
{
	...
	send: function(arr,callback,act,hdr,callerror,add,json)
	{
...
function ajaxToRCP(qArr,collback,act,hdr,collerror,add,json)
{
	...
	if(typeof json=="undefined")
		json=0;
	var qFrm=new sendForm(qArr,collback,act,hdr,collerror,add,json);
	qFrm.ajaxForm.send(qArr,collback,act,hdr,collerror,add,json);
	qFrm=null;
}
...
function goToLocation(o)/*переключение между страницами сайта*/
{
