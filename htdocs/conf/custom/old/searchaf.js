...
function seeTreeM(o,c,l,q,pq,ll)/*запрос на рубрики в виде дерева*/
{
	typework="";
	treeobj=c;
...
function seeAlso(o,c)/*ссылка см.также*/
{
	typework="search";
	var gArr=new Array();
	var querylist=new Array();
...
function seeAlsoOtherLanguage(o)/*ссылка см.также на другом языке*/
{
	typework="search";
	var gArr=new Array();
	var querylist=new Array();
