...
<!-- из файла ../tpl/headerbottom.html -->
							<div class="bottom"></div> <!-- для чего кнопка? -->
<!-- 				
...
<nav class="navbar navbar-expand-lg navbar-light bg-light" style="min-height: 40px;">
  <div class="container-fluid" style="padding-top: 5px;">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0" style="list-style-type:none;font-size:1.5em;font-weight: bold;display: flex;flex-flow: row nowrap;justify-content: space-around;float:none;">
		<li class="nav-item">
          <a class="nav-link active" href="#">Читателям</a>
        </li>
   
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">О БИБЛИОТЕКЕ</a>
		<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
				<li><a class="dropdown-item" href="/ru/pages/index/adress">Адрес и время работы</a></li>
        
				<li><a class="dropdown-item" href="/ru/pages/index/zapis">Запись читателей</a></li>
        
				<li><a class="dropdown-item" href="/ru/pages/index/info">Общая информация</a></li>
        
				<li><a class="dropdown-item" href="/ru/pages/index/history">Из истории РГБИ</a></li>
        
				<li><a class="dropdown-item" href="/ru/pages/index/otdels">Структура библиотеки</a></li>
        
				<li><a class="dropdown-item" href="/ru/pages/index/req">Реквизиты библиотеки</a></li>
        ...
        <li class="nav-item">
          <a class="nav-link disabled" href="#" tabindex="-1" aria-disabled="true">Коллегам</a>
        </li>

		<li class="nav-item">
          <a class="nav-link active" href="#">Спроси библиографа</a>
        </li>
      </ul>
