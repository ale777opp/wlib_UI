...
<!--/td> </tr-->
<tr> <!--вывод текста о наличии электронного документа-->
	<td>
		<table>
			<tr>
				<td colspan="5">
						<span class="smalltext">
						<!--xsl:value-of select="entry[position()=14]"/-->
						<xsl:value-of select="REQUEST/entry[14]"/>
					</span>
				</td>
				<td colspan="5">
						<span class="smalltext">
						<!--xsl:value-of select="entry[position()=14]"/-->
						<xsl:value-of select="REQUEST/entry[13]"/>
					</span>
				</td>
			</tr>
		</table>
